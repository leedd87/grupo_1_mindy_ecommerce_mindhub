...
function displayCarrito(articulos){
    ...
    templateHtml += `
            <tr>
                ...
                <td></td>
                <td>${sumatoria}</td>
                <td><button class="btnBorrar" onclick="limpiarCarrito()"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart-x-fill" viewBox="0 0 16 16">
